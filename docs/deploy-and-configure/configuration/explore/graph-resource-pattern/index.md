...
A _human friendly_ representation can be generatled using [json-schema-for-humans](https://json-schema-viewer.vercel.app/view?url=https://dev.documentation.eccenca.com/deploy-and-configure/configuration/explore/graph-resource-pattern/schema.json&description_is_markdown=on&expand_buttons=on&show_breadcrumbs=on&with_footer=on&template_name=js#pathFilters).
