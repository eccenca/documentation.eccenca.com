...
The [Mapping Creator can optionally use LLM](../../../build/mapping-creator/index.md#create-a-mapping-with-smart-suggestions) to automatically generate class and property mappings.
