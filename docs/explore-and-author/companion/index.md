...
!!! info "Configuration"
    ...
    See [`spring.ai.*` configurationproperties of Configuration of Servlet Container section](../../deploy-and-configure/configuration/explore/dataplatform/application-full/#configuration-of-servlet-container) to learn how to enable and configure this feature.
