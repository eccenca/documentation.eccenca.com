...
- <code>[StatusInfo](../models/status.md#cmem_client.models.status.StatusInfo)</code> – StatusInfo with version, health, and error per component. The
- <code>[StatusInfo](../models/status.md#cmem_client.models.status.StatusInfo)</code> – overall health is exposed via the StatusInfo.health property.
