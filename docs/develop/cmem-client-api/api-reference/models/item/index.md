---
title: "cmem-client: models.item module"
...
# `cmem_client.models.item` {#cmem_client.models.item}
...
Bases: <code>ABC</code>, <code>[Model](../../models/base/index.md#cmem_client.models.base.Model)</code>
