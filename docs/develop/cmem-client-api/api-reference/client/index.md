...
# `cmem_client.client` {#cmem_client.client}
...
[LoggingConfig](../models/logging_config/index.md#cmem_client.models.logging_config.LoggingConfig) before handing it to
...
[log_method](../logging_utils/index.md#cmem_client.logging_utils.log_method) decorator log their arguments on
...
- [**config**](#cmem_client.client.Client.config) (<code>[Config](../config/index.md#cmem_client.config.Config)</code>) – Configuration object containing URLs and connection settings.
- **_headers** (<code>dict</code>) – Class-level dictionary of HTTP headers shared across instances.
- **_auth** (<code>[AuthProvider](../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider)</code>) – Authentication provider for obtaining access tokens.
- **_http** (<code>Client</code>) – HTTP client instance for making API requests.
- **_workspace** (<code>[BuildWorkspace](../components/workspace/index.md#cmem_client.components.workspace.BuildWorkspace)</code>) – DataIntegration workspace component for build operations.
- **_store** (<code>[GraphStore](../components/graph_store/index.md#cmem_client.components.graph_store.GraphStore)</code>) – DataPlatform graph store component for explore operations.
...
- **config** (<code>[Config](../config/index.md#cmem_client.config.Config)</code>) – Configuration object containing base URLs, SSL settings,
and other connection parameters.
- **auth** (<code>[AuthProvider](../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider) | None</code>) – Optional authentication provider. If given, it is applied
...
- <code>[AuthProvider](../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider)</code> – The currently configured AuthProvider instance.

**Raises:**

- <code>[ClientNoAuthProviderError](../exceptions/index.md#cmem_client.exceptions.ClientNoAuthProviderError)</code> – If no authentication provider has been
...
- <code>[ClientAccountRepository](../repositories/client_accounts/index.md#cmem_client.repositories.client_accounts.ClientAccountRepository)</code> – The ClientAccountRepository instance, created lazily on first access.
...
- <code>[DatasetsRepository](../repositories/datasets/index.md#cmem_client.repositories.datasets.DatasetsRepository)</code> – The DatasetsRepository instance, created lazily on first access.
...
- <code>[Deployment](../components/deployment/index.md#cmem_client.components.deployment.Deployment)</code> – The Deployment component instance, created lazily on first access.
...
- <code>[GraphsRepository](../repositories/graphs/index.md#cmem_client.repositories.graphs.GraphsRepository)</code> – The GraphRepository component instance, created lazily on first access.
...
- <code>[Marketplace](../components/marketplace/index.md#cmem_client.components.marketplace.Marketplace)</code> – The Marketplace component instance, created lazily on first access.
...
- <code>[ProjectsRepository](../repositories/projects/index.md#cmem_client.repositories.projects.ProjectsRepository)</code> – The ProjectsRepository component instance, created lazily on first access.
...
- <code>[QueriesRepository](../repositories/queries/index.md#cmem_client.repositories.queries.QueriesRepository)</code> – The QueriesRepository instance, created lazily on first access.
...
- <code>[SchedulersRepository](../repositories/schedulers/index.md#cmem_client.repositories.schedulers.SchedulersRepository)</code> – The SchedulersRepository instance, created lazily on first access.
...
- <code>[GraphStore](../components/graph_store/index.md#cmem_client.components.graph_store.GraphStore)</code> – The GraphStore component instance, created lazily on first access.
...
- <code>[UserAccountRepository](../repositories/user_accounts/index.md#cmem_client.repositories.user_accounts.UserAccountRepository)</code> – The UserAccountRepository instance, created lazily on first access.
...
- <code>[VariablesRepository](../repositories/variables/index.md#cmem_client.repositories.variables.VariablesRepository)</code> – The VariablesRepository instance, created lazily on first access.
...
- <code>[VocabulariesRepository](../repositories/vocabularies/index.md#cmem_client.repositories.vocabularies.VocabulariesRepository)</code> – The VocabulariesRepository instance, created lazily on first access.
...
- <code>[BuildWorkspace](../components/workspace/index.md#cmem_client.components.workspace.BuildWorkspace)</code> – The BuildWorkspace component instance, created lazily on first access.
