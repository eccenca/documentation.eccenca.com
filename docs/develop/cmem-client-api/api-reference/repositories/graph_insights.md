...
- <code>[GraphInsightSnapshot](../models/graph_insight.md#cmem_client.models.graph_insight.GraphInsightSnapshot)</code> – A GraphInsightSnapshot with current status fields.
...
- <code>[GraphInsightSnapshot](../models/graph_insight.md#cmem_client.models.graph_insight.GraphInsightSnapshot)</code> – The snapshot once it reaches a terminal state.
