---
title: "cmem-client: repositories.user_accounts module"
...
- <code>list[[Group](../../models/user/index.md#cmem_client.models.user.Group)]</code> – List of Group objects currently assigned to the user.
...
- <code>list[[Group](../../models/user/index.md#cmem_client.models.user.Group)]</code> – List of Group objects available in the realm.
