---
title: "cmem-client: repositories.vocabularies module"
description: "Repository for managing vocabularies in Corporate Memory."
tags:
  - API
  - Python
  - cmem-client
...
Bases: <code>[Repository](../../repositories/base/abc/index.md#cmem_client.repositories.base.abc.Repository)[[Vocabulary](../../models/vocabulary/index.md#cmem_client.models.vocabulary.Vocabulary)]</code>
...
- <code>dict[str, [Vocabulary](../../models/vocabulary/index.md#cmem_client.models.vocabulary.Vocabulary)]</code> – Mapping of vocabulary IRI to Vocabulary catalog entry.
...
- <code>[VocabularyCache](../../models/vocabulary/index.md#cmem_client.models.vocabulary.VocabularyCache)</code> – The global vocabulary cache as a VocabularyCache model.
...
- **on_conflict** (<code>[ImportConflictPolicy](../../repositories/protocols/import_item/index.md#cmem_client.repositories.protocols.import_item.ImportConflictPolicy)</code>) – How to handle a graph that already exists. Defaults to REPLACE.
...
- <code>list[[Vocabulary](../../models/vocabulary/index.md#cmem_client.models.vocabulary.Vocabulary)]</code> – Filtered list of Vocabulary objects.
...
- <code>[VocabularyUninstallError](../../exceptions/index.md#cmem_client.exceptions.VocabularyUninstallError)</code> – If the vocabulary is not installed.
