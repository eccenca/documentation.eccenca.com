---
title: "cmem-client: repositories.files module"
...
# `cmem_client.repositories.files` {#cmem_client.repositories.files}
...
- <code>[FilesReadError](../../exceptions/index.md#cmem_client.exceptions.FilesReadError)</code> – If the key is malformed or the request fails.
- <code>[FilesNotFoundError](../../exceptions/index.md#cmem_client.exceptions.FilesNotFoundError)</code> – If the file does not exist in the project.
