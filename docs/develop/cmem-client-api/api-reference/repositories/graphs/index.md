---
title: "cmem-client: repositories.graphs module"
...
- <code>[GraphExportError](../../exceptions/index.md#cmem_client.exceptions.GraphExportError)</code> – If the file already exists and replace is False, or if
