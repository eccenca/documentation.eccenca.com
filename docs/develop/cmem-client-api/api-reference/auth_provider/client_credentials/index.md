---
title: "cmem-client: auth_provider.client_credentials module"
...
Bases: <code>[AuthProvider](../../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider)</code>
...
- [**config**](#cmem_client.auth_provider.client_credentials.ClientCredentialsFlow.config) (<code>[Config](../../config/index.md#cmem_client.config.Config)</code>) – Corporate Memory configuration containing endpoint URLs.
...
- [**token**](#cmem_client.auth_provider.client_credentials.ClientCredentialsFlow.token) (<code>[KeycloakToken](../../models/token/index.md#cmem_client.models.token.KeycloakToken)</code>) – Currently cached Keycloak token with expiration tracking.
...
- **config** (<code>[Config](../../config/index.md#cmem_client.config.Config)</code>) – Corporate Memory configuration containing OAuth endpoint URLs
...
- <code>[KeycloakToken](../../models/token/index.md#cmem_client.models.token.KeycloakToken)</code> – A new KeycloakToken instance with the fresh access token and
- <code>[KeycloakToken](../../models/token/index.md#cmem_client.models.token.KeycloakToken)</code> – expiration information.
...
- <code>[AuthProvider](../../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider)</code> – A ``ProvidedToken`` authentication provider backed by the
- <code>[AuthProvider](../../auth_provider/abc/index.md#cmem_client.auth_provider.abc.AuthProvider)</code> – context's ``UserContext.token()`` method.
...
- <code>[ClientEnvConfigError](../../exceptions/index.md#cmem_client.exceptions.ClientEnvConfigError)</code> – If ``OAUTH_CLIENT_SECRET`` is missing or empty.
...
- <code>[ClientEnvConfigError](../../exceptions/index.md#cmem_client.exceptions.ClientEnvConfigError)</code> – If the required OAUTH_CLIENT_SECRET environment
variable is not set.
