...
- [**failed_tasks**](#cmem_client.models.workspace_status.ProjectStatus.failed_tasks) (<code>list[[FailedTasksReport](../models/project.md#cmem_client.models.project.FailedTasksReport)]</code>) – The failed tasks themselves, with the error of each.
