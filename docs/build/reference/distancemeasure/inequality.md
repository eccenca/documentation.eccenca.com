...
- [equality](equality.md) — The string equality plugin covers the complementary case: success when values are equal, where the inequality plugin would return failure.
