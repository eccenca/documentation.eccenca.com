...
|--------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------:|:-------------------------|
 ...
 | [Strip URI prefix](Substring/stripUriPrefix.md) | Substring | Strips the URI prefix and decodes the remainder based on UTF-8 URL decoding (using java.net.URLDecoder). Leaves values unchanged which are not a valid URI. |
 ...
 | [Zip](Combine/zip.md) | Combine | Concatenates the values of two inputs in pairs. |
