...
-   [dbpedia.csv](dbpedia.csv)
    ...
    !!! info
        ...
        ![image](preview-dbpedia.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   [linkedmdb.csv](linkedmdb.csv)

    !!! info

        ![image](preview-linkedmdb.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

## 1. Create a new project

-   Once logged in to eccenca Corporate memory on the right side click on **Create :eccenca-item-add-artefact:**.

    ![image](22.2-create-project.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on the **project** on the left side in the item type and double-click on the **project** in the centre.
    ...
    ![image](22.2-click-on-project.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Type the project name as **Movie links** in the title field and click on **create.**

    ![image](22.2-type-movielink.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

!!! success "Step Result"

    The project was created with the name "Movie links" which is displayed in the page top left corner.

    ![image](22.2-project-created.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

## 2. Upload the files

-   Click on **add file** on the right side of the page.

    ![image](22.2-click-on-add-files.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on **drop files here** select the file and click on **open**.

    ![image](22.2-upload-files.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Once the file is successfully uploaded click on **close.**

    ![image](22.2-files-uploaded.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
!!! success "Step Result"
    ...
    ![image](22.2-files-added.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

## 3. Create datasets

-   Click on **Create :eccenca-item-add-artefact:**.

    ![image](22.2-click-on-create.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on the **dataset** on the left side in the item type and double-click on the **:eccenca-artefact-dataset-csv: CSV** file in the centre.
    ...
    ![image](22.2-click-on-dataset.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Type the file name as **dbpedia** in the label field.

    ![image](22.2-type-dbpedia.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Tick the option **select file from project** and select the file from the drop-down list of files available in the project.

    ![image](22.2-select-dbpedia-file.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on **create**.

    ![image](22.2-click-on-create1.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Type the label name **links.csv** in the label field.
    ...
    ![image](22.2-type-links.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Tick the option **create empty file** and select the file name from the drop-down list as **link.csv** then click on **create**.

    ![image](22.2-click-on-emptyfiles.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
!!! success "Step result"
    ...
    ![image](22.2-dataset-created.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on **:eccenca-artefact-linking: Linking** on the left side in the item type and double-click on **linking** in the center.
    ...
    ![image](22.2-click-on-linking.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Type the name as **linking** in the label field and select the **source input** data set as a **dbpedia** file.

    ![image](22.2-type-linking.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Select the **type** field (it gives the default name) select the same and click on **create**.

    ![image](22.2-select-type-field.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   In the continuation to the same page go down, select the **target input** dataset as a **linkedmdb** file.

    ![image](22.2-target-input.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Select the **type** field (it gives the default name) select the same and click on **create**.

    ![image](22.2-selecttype-field.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Select the **output dataset** as **link.csv** file.

    ![image](22.2-select-output.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on **create**.

    ![image](22.2-linking-click-on-create.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
!!! success "Step Result"
    ...
    ![image](22.2-linking-created.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on the **:eccenca-data-sourcepath: source path** and drag the title on the canvas.
    ...
    ![image](22.2-click-on-sourcepath.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on the **:eccenca-data-targetpath: target path** and drag the title on the canvas.

    ![image](22.2-click-on-targetpath.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on **:eccenca-operation-transform: transform**, type the operator **lowercase**  in the search field and drag the same on the canvas twice.
    ...
    ![image](22.2-lowercase.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Drag the little dot on the right side of the source path box onto the left dot of the transformation box (lower case) to connect the two with a line (you always must drag from the right side of one element to the left side of another to connect the two).
    ...
    ![image](22.2-source-lowercase.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Drag the little dot on the right side of the target path box onto the left dot of the transformation box (lower case) to connect the two with a line (you always must drag from the right side of one element to the left side of another to connect the two).
    ...
    ![image](22.2-target-lowercase.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on **:eccenca-operation-comparison: comparison** and type the **equality** in the search field and drag the `string equality` operation onto the canvas.
    ...
    ![image](22.2-comparison.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Drag the little dot on the right side of both lowercase boxes onto the left dot of the string equality box to connect the two with a line (you always must drag from the right side of one element to the left side of another to connect the two).
    ...
    ![image](22.2-lower-string.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on **save** on the right side of the page.
    ...
    ![image](22.2-comparison-save.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on the **linking evaluation**.
    ...
    ![image](22.2-click-on-linking-evaluation.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on the **:eccenca-item-start: button** to start the evaluation and generate the links.

    ![image](22.2-start-evalute.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
!!! success "Step Result"
    ...
    ![image](22.2-evalute-result.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

-   Click on the **:eccenca-toggler-showmore:** button to **expand all**.

    ![image](22.2-expand-all.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

!!! success "Step Result"

    This allows you to see how the linking rule was performed for each link and even the movie name compared in both files.

    ![image](22.2-expand-result.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
!!! success "Task"
    ...
    ![image](22.2-type-shaft.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

    Cross-checking in the `dbpedia.csv` and `linkedmdb.csv` data sheet.

    ![image](22.2-shaft-result.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
...
-   Click on the linking execution then click on the **:eccenca-item-start: button** to execute the links (It copies the links to our data file `links.csv` (which is our output file).
    ...
    ![image](22.2-start-activity.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }

!!! success "Step Result"

    The links are executed and copied to the output data file `links.csv` and which shows the count of links on the page.

    ![image](22.2-linking-result.png){ width="75%" style="border: 1px solid #555; border-radius: 5px;" }
