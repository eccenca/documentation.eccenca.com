...
The eccenca Corporate Memory platform can connect to Snowflake to take advantage of Snowflake’s scalability and flexibility for data warehousing solutions.
...
VALUES (11, 'Memristor Encoder', 'Siglind.Brinkerhoff', 'Siglind.Brinkerhoff Company.org', '3,79 EUR', 30, 22, 19, 2)
```
