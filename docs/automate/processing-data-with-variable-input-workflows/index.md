...
The workflow is then called via an HTTP REST call (or via [cmemc](../cmemc-command-line-interface/)), thus uploading the payload data "at the place" of this variable input dataset and executing all following parts of the workflow.
...
!!! Abstract  
    ...
    - by using the [command line interface](../cmemc-command-line-interface/)
