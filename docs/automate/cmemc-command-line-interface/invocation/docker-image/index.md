...
In addition to the cmemc distribution package, you can use the eccenca cmemc docker image, which is based on the [Red Hat Universal Base Image 10 Minimal](https://hub.docker.com/r/redhat/ubi10-minimal).
...
- `docker-registry.eccenca.com/eccenca-cmemc:v26.2.0` - a specific release
...
$ docker run -it --rm docker-registry.eccenca.com/eccenca-cmemc:v26.2.0 --version
Unable to find image 'docker-registry.eccenca.com/eccenca-cmemc:v26.2.0' locally
v26.2.0: Pulling from eccenca-cmemc
...
Digest: sha256:....
Status: Downloaded newer image for docker-registry.eccenca.com/eccenca-cmemc:v26.2.0
cmemc, version 26.2.0, running under python 3.13.8
```
...
$ docker run -it --rm -v "$(pwd)"/cmemc.ini:/config/cmemc.ini docker-registry.eccenca.com/eccenca-cmemc:v26.2.0 config list
my-deployment
```
...
$ docker run -it --rm -v $(pwd):/data -v $(pwd)/cmemc.ini:/config/cmemc.ini docker-registry.eccenca.com/eccenca-cmemc:v26.2.0 -c my-deployment query execute ./list-graphs.sparql
graph,triples
