...
def test_originals_below_150_ppi_at_their_printed_size_are_listed_once(tmp_path, monkeypatch):
    ...
    Image.new("RGB", (100, 50), "white").save(site / "build/narrow.png")
    doc = BeautifulSoup(
        '<p><img src="/build/small.png" alt=""/><img src="/build/wide.png" alt=""/>'
        '<img src="/build/half.png" width="50%" alt=""/><img src="/build/small.png" alt=""/>'
        '<img src="/build/narrow.png" width="25%" alt=""/></p>',
        "html.parser",
    )
    low: dict[str, tuple[int, str]] = {}
    ...
    # 16 cm column at 317 ppi; 600 px at 50 % of the column print at 190 ppi; and
    # 100 px at 25 % of it print at 64 ppi, listed with the width of the source.
    assert low == {"build/small.png": (72, ""), "build/narrow.png": (64, "25%")}
...
def test_accepted_originals_are_not_listed(tmp_path):
    ...
    low = {"build/small.png": (72, ""), "build/tiny.png": (40, "20%"), "build/mid.png": (120, "")}
    assert unaccepted_low_resolution(low, accepted) == [
        ("build/tiny.png", 40, "20%"),
        ("build/mid.png", 120, ""),
    ]
