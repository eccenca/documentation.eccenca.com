...
| `image-widths` | `task check:images` | List raster images that print below 150 ppi in pages that are not generated; `--fix` writes the `width="NN%"` their pixels support in the 16 cm print column |
